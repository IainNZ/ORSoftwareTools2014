...
Lecture slides are given in `HPCslides.pdf`. Slides link to the corresponding code files with solutions to the exercises.


## Installation Instructions

We will use Julia and R, which should already be installed from previous modules.
